class Matrix3
{
    ...
    static public void Multiply( Vector3 r, Matrix3 m, Vector3 v )
    {
        float x = m.d00 * v.x + m.d01 * v.y + m.d02 * v.z;
        float y = m.d10 * v.x + m.d11 * v.y + m.d12 * v.z;
        float z = m.d20 * v.x + m.d21 * v.y + m.d22 * v.z;
    ...
    static final private double Quarter = Math.PI / 2.0;
